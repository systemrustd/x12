...
Extensions implemented: BIG-REQUESTS, COMPOSITE, DAMAGE, DRI3,
Generic Event Extension, GLX (modern direct-rendering only via
DRI3/Present), MIT-SHM, PRESENT, RANDR, RENDER, SHAPE, SYNC,
